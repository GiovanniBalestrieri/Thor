...
float riferimentoSx = 8.0 * MS_RAPPORTO_INGR; // [-470 ; 470]  (rad/s)
float riferimentoDx = 8.0 * MD_RAPPORTO_INGR;
...
#define Ts 2000 //us
#define Kp_1 5.2f //0.8
#define Ki_1 0.3f
#define Kd_1 0.0f
#define MS_STATIC_FRIC  (-2.0*22.0)
#define ControlDeadzone_1 5 //deadzone for u, the control variable
//Kp 2.8 Ki 0.2  0->10
#define Kp_2 2.8f
#define Ki_2 0.2f
#define Kd_2 0.0f
#define MD_STATIC_FRIC  (2.0*17.0)
