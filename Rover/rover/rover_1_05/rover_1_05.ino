 ...
 *  - encoder b direction
 *  - clear code
 *  - TODO: overflow (1 ora), static friction dinamica
...
#define Ki_1 0.3f
#define Kd_1 0.0f
#define MS_STATIC_FRIC  (-22.0)
#define Kp_2 2.8f
#define Ki_2 0.2f
#define Kd_2 0.0f
#define MD_STATIC_FRIC  (17.0)
...
float riferimentoSx = 5.0 * MS_RAPPORTO_INGR; // [-470 ; 470]  (rad/s)
float riferimentoDx = 5.0 * MD_RAPPORTO_INGR;
...
{   
  ...
  //MS_STATIC_FRIC = IdentifyStaticFrictionPwm(); // Per ora costanti
  //MD_STATIC_FRIC = IdentifyStaticFrictionPwm();
